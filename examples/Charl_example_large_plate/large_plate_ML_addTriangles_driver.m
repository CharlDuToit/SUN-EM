...
[newAllTerms, newAllProperties, newSingInd, calculatedNonSingInd, calculatedTriInd, calculatedSelfInd] = ...
    projectOldSolverSetup(new_solver_setup, Solver_setup,newEdgeLinkOldEdge, newEdgeParallelExternalEdgeLinkOldInternalEdge,  mlmom_oldSolverSetup.allTerms, mlmom_oldSolverSetup.allProperties, mlmom_oldSolverSetup.singInd );
projectTime = toc;
tic;
